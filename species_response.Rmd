...
library(ggpubr)
library(reshape2)
setwd("D:/SyncProjects/PhD/Chapters/RQ1/Submission/SupplementaryMaterial/Supplementary_3")
...
ggplot(data=m, aes(x=variable, y=value, group=species)) +
  ...
  scale_linetype_manual(values=c("dotted", "dotted","dotted", "dotted","solid", "solid","solid","solid","dotted", "dotted"))+
  ...
  ylab("Moran's I")+theme_Publication()+theme(legend.position = "bottom",legend.box="vertical")+
   guides(linetype = guide_legend(ncol = 4, byrow = TRUE))
```
