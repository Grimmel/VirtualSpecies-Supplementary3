...
prevalence75 <- read.csv("data/prevalence_75.csv")
prevalence85 <- read.csv("data/prevalence_85.csv")
...
ggplot(data=out,aes(x=area,y=yhat,linetype=species,color=species))+
  geom_line(size=1.2)+
    scale_linetype_manual(values=c("dashed", "dashed","dashed", "dashed","solid", "solid","solid","solid","twodash", "twodash"))+
